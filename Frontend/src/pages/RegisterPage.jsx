...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check if err from authService has an array of validation errors (Zod format)
      // The auth.js service throws a generic Error string right now, let's fix that or handle the string.
      // Since our auth.js service grabs `error.response.data.message`, let's see if we can expose `errors` array too.
